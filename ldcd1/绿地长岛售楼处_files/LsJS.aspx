var LR_e7bfc='F244E0A55A4B49DE857E8E10959742B5';var LR_isMobile = 0;
var LR_siteid = '35928994';
var LR_ssl = 1;
...
var LR_b1d09=LR_e7bfc.replace(/4/g,'8').replace(/5/g,'3');var LR_imgurl = 'https://kht.zoosnet.net/';
var LR_lng = 'cn';
var LR_sysurl = 'https://kht.zoosnet.net/';
var LR_websiteid = 'KHT35928994';
LR_b1d09=((3+2).toString()+LR_b1d09+(3*2).toString());LR_b1d09=LR_b1d09.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_HJDI=LR_b1d09.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_invitestring=unescape("%3cP style%3d%22FONT-SIZE%3a 9pt%22%3e%u60a8%u597d%uff0c%u8fd9%u91cc%u662f%u5f00%u53d1%u5546%u7f51%u4e0a%u552e%u697c%u5904%uff0c%u6709%u4ec0%u4e48%u95ee%u9898%u53ef%u4ee5%u5e2e%u60a8%u7684%uff01%3c%2fP%3e");
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&DHKI='+LR_HJDI;
