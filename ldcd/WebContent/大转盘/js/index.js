...
$(document).ready(function(){
	...
	$rotaryArrow.click(function(){
		...
		if($.cookie('rotary_time_hzh')==null){
			...
			switch(data){
				case 1:
					rotateFunc(1,130,'恭喜您获得了到场红包100元！');
					break;
				case 2:
					rotateFunc(2,225,'恭喜您获得了到场红包200元！');
					break;
				case 3:
					rotateFunc(4,0,'恭喜您获得了到场红包300元！');
					break;
				case 4:
					rotateFunc(3,180,'恭喜您获得了到场红包400元！');
					break;
				case 5:
					rotateFunc(5,85,'恭喜您获得了到场红包500元！');
					break;
				case 6:
					rotateFunc(6,40,'恭喜您获得了到场红包600元！');
					break;
				case 7:
					rotateFunc(7,315,'恭喜您获得了到场红包700元！');
					break;
				default:
